 ...
 * @Version:1.0
 */
public class MusicException extends Exception implements CustomException {
    /**
     ...
     * @since 1.7
     */
    protected MusicException(String message, Throwable cause, boolean enableSuppression, boolean writableStackTrace) {
